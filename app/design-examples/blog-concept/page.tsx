...
export default function BlogConceptPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col font-sans">
      {/* Navigation */}
      <header className="fixed w-full top-0 px-4 sm:px-6 py-4 sm:py-6 flex justify-between items-center z-50 bg-black/80 backdrop-blur-sm">
        ...
        <div className={`fixed inset-0 bg-black/95 backdrop-blur-sm z-40 transform transition-transform duration-300 ease-in-out sm:hidden ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="flex flex-col h-full pt-20 px-6">
            <nav className="flex flex-col gap-6">
              ...
              <Link href="#" className="text-xl text-white hover:text-gray-200 transition-colors">Blog</Link>
      ...
      <section className="pt-24 sm:pt-32 pb-12 sm:pb-16 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold mb-6 sm:mb-8">Projects</h1>
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <article className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold mb-4">Designing with Contrast and Hierarchy</h2>
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 bg-neutral-950">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold mb-8 sm:mb-12">Recent Articles</h2>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[1, 2, 3].map((item) => (
              <article key={item} className="group">
                <div className="aspect-video bg-neutral-900 rounded-xl mb-4 sm:mb-6 overflow-hidden relative">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 group-hover:text-gray-300 transition-colors">
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4">
            {['Design', 'Development', 'Case Studies', 'Typography', 'Accessibility', 'Color Theory'].map((category) => (
              <Link 
                key={category}
                href="#" 
                className="px-4 sm:px-6 py-2 sm:py-3 rounded-full border border-neutral-800 text-sm hover:bg-white hover:text-black transition-colors"
              >
                {category}
              </Link>
            ))}
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 bg-neutral-950">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">Subscribe to my newsletter</h2>
          ...
          <form className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-md mx-auto">
            <input 
              ...
              className="flex-1 px-4 sm:px-6 py-2 sm:py-3 bg-neutral-900 rounded-full text-white border border-neutral-800 focus:outline-none focus:border-white text-sm sm:text-base"
            />
            <button 
              type="submit"
      ...
      {/* Footer */}
      <footer className="py-12 sm:py-16 px-4 sm:px-6 border-t border-neutral-900 mt-auto">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          <div>
            <div className="text-xl sm:text-2xl font-bold mb-4">NH.</div>
        ...
        <div className="max-w-6xl mx-auto pt-8 sm:pt-12 mt-8 sm:mt-12 border-t border-neutral-900 text-center text-sm text-gray-500">
