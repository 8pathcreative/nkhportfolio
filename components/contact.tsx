        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-col gap-4">
            <Link
              ...
              className="inline-flex items-center hover:text-primary duration-200"
            >
            ...
            <a
              ...
              className="flex items-center gap-2 bg-neutral-900 hover:bg-neutral-800 transition-colors px-4 py-3 rounded-lg border border-neutral-800"
            >
